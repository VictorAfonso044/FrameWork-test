...
<h1 class="justify-content-center mb-50"> Informe o número de dados que deseja:</h1>
<h6 class="justify-content-center" style="font-weight:bold;">Maximo: 200 </h6>
<form class="navbar-form justify-content-center " action="todos.php" metod="get">
  <div class="input-group">
    <input name='num' type="number" class="form-control" placeholder="Número" min="0" max="200">
