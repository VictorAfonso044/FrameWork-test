...
<div class="container-fluid ">
	...
	<h1>Clique a baixo e descubra informações sobre:</h1>
</div>
	<ul class="justify-content-center">
      <li class="body-link"><a href="todos.php" >Todos</a></li>
      <li class="body-link"><a href="postagens.php" >Postagens</a></li>
      <li class="body-link"><a href="albuns.php">Albuns</a></li>
	</ul>
